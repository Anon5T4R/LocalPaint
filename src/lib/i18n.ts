...
const pt = {
  ...
  "sel.expand": "Expandir seleção 1 px",
  "sel.contract": "Contrair seleção 1 px",
  "tool.text": "Texto (T)",
  ...
  "layers.pasted": "Imagem colada",

  "top.addImage": "Adicionar imagem",
  "top.addImageTip": "Adicionar um arquivo de imagem como camada nova (arrastar pra janela e Ctrl+V também funcionam)",
  "io.pasteNoImage": "Nenhuma imagem na área de transferência",
  ...
  "io.imageScaled": "a imagem era maior que a tela e foi reduzida pra caber",
...
const en: Record<MessageKey, string> = {
  ...
  "sel.expand": "Expand selection 1 px",
  "sel.contract": "Contract selection 1 px",
  "tool.text": "Text (T)",
  ...
  "layers.pasted": "Pasted image",

  "top.addImage": "Add image",
  "top.addImageTip": "Add an image file as a new layer (dropping onto the window and Ctrl+V also work)",
  "io.pasteNoImage": "No image on the clipboard",
  ...
  "io.imageScaled": "the image was larger than the canvas and was scaled down to fit",
...
const es: Record<MessageKey, string> = {
  ...
  "sel.expand": "Expandir selección 1 px",
  "sel.contract": "Contraer selección 1 px",
  "tool.text": "Texto (T)",
  ...
  "layers.pasted": "Imagen pegada",

  "top.addImage": "Añadir imagen",
  "top.addImageTip": "Añadir un archivo de imagen como capa nueva (arrastrar a la ventana y Ctrl+V también funcionan)",
  "io.pasteNoImage": "No hay imagen en el portapapeles",
  ...
  "io.imageScaled": "la imagen era más grande que el lienzo y se redujo para caber",
